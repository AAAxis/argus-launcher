...
describe('reviseRow', () => {
  ...
  it('accepts one of the library proxies instead', () => {
    const proxy: ArgusProxy = {id: 'p9', name: 'p9', type: 'http', host: '9.9.9.9', port: 80};
...
describe('folders', () => {
  ...
  it('matches an existing folder by name, case-insensitively', () => {
    const folder: ArgusFolder = {id: 'f1', name: 'team'};
...
describe('export round-trip', () => {
  ...
  const folder: ArgusFolder = {id: 'f1', name: 'Storefronts'};

...
export const PROFILE_INTRO_STEPS: IntroStep[] = [
  ...
  },
  {
    ...
    body: 'The platform and fingerprint decide what a site sees; the proxy decides where ' +
      'it appears to be. Monti keeps those consistent for you: pick a platform and the ' +
  ...
  },
  {
    ...
    body: 'Launch opens Monti Browser on that identity. As the list grows, folders group ' +

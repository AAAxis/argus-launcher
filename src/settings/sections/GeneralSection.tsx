      ...
      <SettingsGroup title="Startup">
        <SettingsRow
          ...
          description={loginItem && !loginItem.packaged ?
            'Unavailable in a development run — the entry would point at Electron, not at Argus Launcher.' :
            'Start Argus Launcher when you sign in to this computer.'}
        >
          <label className="switch" aria-label="Open Argus Launcher at login">
            <input

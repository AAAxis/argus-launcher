...
const LAUNCHER_RELEASES: ReleaseEntry[] = [
  ...
  },
  {
    ...
    notes: 'Monti Panel follow-ups, statuses for proxies and cookie-sets, and the\ncollapsible sidebar rail.',
  },
...
const BROWSER_RELEASES: ReleaseEntry[] = [
  {
    tag: 'browser-v151.0.7906.0-mac-arm64', version: '151.0.7906.0', name: 'Monti Browser 151.0.7906.0',
    publishedAt: minutesAgo(60 * 10),
    notes: 'Chromium 151. Injector rebuilt against the new bindings.',
  },
  {
    tag: 'browser-v150.0.7100.0-mac-arm64', version: '150.0.7100.0', name: 'Monti Browser 150.0.7100.0',
...
function resource(overrides: Partial<ResourceState> = {}): ResourceState {
  return {
    ...
    browserPath: '/Users/roman/Library/Application Support/monti-anty/Browser/v-aRSCo2rF7erpS/Monti.app',

...
import type {ArgusCookie, ArgusFolder, ArgusProfile, ArgusProxy, CloudState} from '../types';
...
export type ProfileCellActions = {
  setName: (profile: ArgusProfile, name: string) => void;
  setStatus: (profile: ArgusProfile, status: string) => void;
  setTags: (profile: ArgusProfile, tags: string[]) => void;
  setPlatform: (profile: ArgusProfile, os: string) => void;
  setAssignee: (profile: ArgusProfile, userId: string) => void;
  setProxy: (profile: ArgusProfile, proxyId: string) => void;
  setAutomation: (profile: ArgusProfile, automationId: string) => void;
  setCookieSet: (profile: ArgusProfile, cookieId: string) => void;
  setStartUrl: (profile: ArgusProfile, url: string) => void;
  setFingerprint: (
    profile: ArgusProfile, patch: NonNullable<ArgusProfile['fingerprint']>) => void;
...
function fingerprintLink(
    profile: ArgusProfile, context: ProfileColumnContext, value: string | undefined) {
  return (
    <CellLink

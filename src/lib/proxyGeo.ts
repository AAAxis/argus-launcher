...
export function expectedTimezoneFor(proxy: ArgusProxy | null | undefined): string | null {
  if (!proxy) {
    return null;
  }
  if (proxy.timezone) {
...
export function proxyLocationLabel(proxy: ArgusProxy | null | undefined): string {
  if (!proxy) {
    return '';
  }
...
export function timezoneMismatch(
    ...
    proxy: ArgusProxy | null | undefined): TimezoneMismatch | null {

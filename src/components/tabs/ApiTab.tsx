...
// reference, `monti_*` tool names in the agent briefs -- and never said that
    ...
    <section className="api-ways">
      <article className="api-way">
        ...
        <p className="api-way-tools">
          <code>monti_list_profiles</code>, <code>monti_launch_profile</code>,{' '}
          <code>monti_navigate</code>, <code>monti_screenshot</code>{' '}
...
export function ApiTab({
  ...
  async function downloadExample() {
    ...
    const defaultName = `monti-api-example-${Date.now()}.js`;
  ...
  return (
    <section className="api-panel">
      ...
      <section className="api-note">
        ...
        <span>Everything on this tab drives Monti on this machine — the same profiles, proxies and automations you see in the app, reached over its local API.</span>
      </section>

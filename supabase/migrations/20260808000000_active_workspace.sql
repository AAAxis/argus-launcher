...
-- launcher kept localStorage['argus.activeOrgId'], which is per machine and per
...
-- ─────────────────────────────────────────────────────────────────────────────
--
-- A table, not auth.users.raw_user_meta_data, where argus_display_name,
-- argus_avatar_url and argus_table_columns already live. Three reasons, in
-- order of weight:
--

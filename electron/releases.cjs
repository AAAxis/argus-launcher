...
//
// AAAxis/argus-launcher is public, so the release list needs no token. Both
...
const RELEASES_URL = 'https://api.github.com/repos/AAAxis/argus-launcher/releases?per_page=30';

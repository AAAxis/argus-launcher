...
Monti Gate starts browser sessions by spawning Monti Browser with explicit runtime
...
Browser does not sign in to Supabase. Browser does not show the Monti Gate table.
